/*
    ...
    1. Invertir el orden de settea de informacio en la constante handleSubmit en el 
        setCategories
...
const AddCategory = ({ setCategories })  => {
    ...
    const handleSubmit = (e) => {
        ...
        if(inputValue.trim().length > 0){
            ...
            //Se agrega a la lista el valor del input
            //setCategories( cats => [...cats, inputValue ]); 

            //Se invierte el orden en que se agregan las categorias
